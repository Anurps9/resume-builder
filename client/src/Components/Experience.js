export function Experience1(props){
    return(
        <div>
            ...
            <input list="month" autocomplete="off" name="experienceStartingMonth1" onChange={props.onChange}/>
            <MonthList />
            <input list="year" autocomplete="off" name="experienceStartingYear1" onChange={props.onChange}/><br/>
            <YearList />
            <input list="month" autocomplete="off" name="experienceEndingMonth1" onChange={props.onChange}/>
            <MonthList />
            <input list="year" autocomplete="off" name="experienceEndingYear1" onChange={props.onChange}/><br/>
            <YearList />
        </div>
    )
}
...
export function Experience2(props){
    return(
        <div>
            ...
            <input list="month" autocomplete="off" name="experienceStartingMonth2" onChange={props.onChange}/>
            <MonthList />
            <input list="year" autocomplete="off" name="experienceStartingYear2" onChange={props.onChange}/><br/>
            <YearList />
            <input list="month" autocomplete="off" name="experienceEndingMonth2" onChange={props.onChange}/>
            <MonthList />
            <input list="year" autocomplete="off" name="experienceEndingYear2" onChange={props.onChange}/><br/>
            <YearList />
        </div>
    )
}
